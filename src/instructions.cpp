...
void initInstrLookupTable()
{
    ...
    instructionLookupTable[0x03] = { "SLO", &Cpu::OpSLO, &Cpu::AddrIZX, 8 };
    instructionLookupTable[0x07] = { "SLO", &Cpu::OpSLO, &Cpu::AddrZP0, 5 };
    instructionLookupTable[0x0F] = { "SLO", &Cpu::OpSLO, &Cpu::AddrABS, 6 };
    instructionLookupTable[0x13] = { "SLO", &Cpu::OpSLO, &Cpu::AddrIZY, 8 };
    instructionLookupTable[0x17] = { "SLO", &Cpu::OpSLO, &Cpu::AddrZPX, 6 };
    instructionLookupTable[0x1B] = { "SLO", &Cpu::OpSLO, &Cpu::AddrABY, 7 };
    instructionLookupTable[0x1F] = { "SLO", &Cpu::OpSLO, &Cpu::AddrABX, 7 };
    instructionLookupTable[0x23] = { "RLA", &Cpu::OpRLA, &Cpu::AddrIZX, 8 };
    instructionLookupTable[0x27] = { "RLA", &Cpu::OpRLA, &Cpu::AddrZP0, 5 };
    instructionLookupTable[0x2F] = { "RLA", &Cpu::OpRLA, &Cpu::AddrABS, 6 };
    instructionLookupTable[0x33] = { "RLA", &Cpu::OpRLA, &Cpu::AddrIZY, 8 };
    instructionLookupTable[0x37] = { "RLA", &Cpu::OpRLA, &Cpu::AddrZPX, 6 };
    instructionLookupTable[0x3B] = { "RLA", &Cpu::OpRLA, &Cpu::AddrABY, 7 };
    instructionLookupTable[0x3F] = { "RLA", &Cpu::OpRLA, &Cpu::AddrABX, 7 };
    instructionLookupTable[0x43] = { "SRE", &Cpu::OpSRE, &Cpu::AddrIZX, 8 };
    instructionLookupTable[0x47] = { "SRE", &Cpu::OpSRE, &Cpu::AddrZP0, 5 };
    instructionLookupTable[0x4F] = { "SRE", &Cpu::OpSRE, &Cpu::AddrABS, 6 };
    instructionLookupTable[0x53] = { "SRE", &Cpu::OpSRE, &Cpu::AddrIZY, 8 };
    instructionLookupTable[0x57] = { "SRE", &Cpu::OpSRE, &Cpu::AddrZPX, 6 };
    instructionLookupTable[0x5B] = { "SRE", &Cpu::OpSRE, &Cpu::AddrABY, 7 };
    instructionLookupTable[0x5F] = { "SRE", &Cpu::OpSRE, &Cpu::AddrABX, 7 };
    instructionLookupTable[0x63] = { "RRA", &Cpu::OpRRA, &Cpu::AddrIZX, 8 };
    instructionLookupTable[0x67] = { "RRA", &Cpu::OpRRA, &Cpu::AddrZP0, 5 };
    instructionLookupTable[0x6F] = { "RRA", &Cpu::OpRRA, &Cpu::AddrABS, 6 };
    instructionLookupTable[0x73] = { "RRA", &Cpu::OpRRA, &Cpu::AddrIZY, 8 };
    instructionLookupTable[0x77] = { "RRA", &Cpu::OpRRA, &Cpu::AddrZPX, 6 };
    instructionLookupTable[0x7B] = { "RRA", &Cpu::OpRRA, &Cpu::AddrABY, 7 };
    instructionLookupTable[0x7F] = { "RRA", &Cpu::OpRRA, &Cpu::AddrABX, 7 };
    instructionLookupTable[0x83] = { "SAX", &Cpu::OpSAX, &Cpu::AddrIZX, 6 };
    instructionLookupTable[0x87] = { "SAX", &Cpu::OpSAX, &Cpu::AddrZP0, 3 };
    instructionLookupTable[0x8F] = { "SAX", &Cpu::OpSAX, &Cpu::AddrABS, 4 };
    instructionLookupTable[0x97] = { "SAX", &Cpu::OpSAX, &Cpu::AddrZPY, 4 };
    instructionLookupTable[0xA3] = { "LAX", &Cpu::OpLAX, &Cpu::AddrIZX, 6 };
    instructionLookupTable[0xA7] = { "LAX", &Cpu::OpLAX, &Cpu::AddrZP0, 3 };
    instructionLookupTable[0xAF] = { "LAX", &Cpu::OpLAX, &Cpu::AddrABS, 4 };
    instructionLookupTable[0xB3] = { "LAX", &Cpu::OpLAX, &Cpu::AddrIZY, 5 };
    instructionLookupTable[0xB7] = { "LAX", &Cpu::OpLAX, &Cpu::AddrZPY, 4 };
    instructionLookupTable[0xBF] = { "LAX", &Cpu::OpLAX, &Cpu::AddrABY, 4 };
    instructionLookupTable[0xC3] = { "DCP", &Cpu::OpDCP, &Cpu::AddrIZX, 8 };
    instructionLookupTable[0xC7] = { "DCP", &Cpu::OpDCP, &Cpu::AddrZP0, 5 };
    instructionLookupTable[0xCF] = { "DCP", &Cpu::OpDCP, &Cpu::AddrABS, 6 };
    instructionLookupTable[0xD3] = { "DCP", &Cpu::OpDCP, &Cpu::AddrIZY, 8 };
    instructionLookupTable[0xD7] = { "DCP", &Cpu::OpDCP, &Cpu::AddrZPX, 6 };
    instructionLookupTable[0xDB] = { "DCP", &Cpu::OpDCP, &Cpu::AddrABY, 7 };
    instructionLookupTable[0xDF] = { "DCP", &Cpu::OpDCP, &Cpu::AddrABX, 7 };
    instructionLookupTable[0xE3] = { "ISB", &Cpu::OpISB, &Cpu::AddrIZX, 8 };
    instructionLookupTable[0xE7] = { "ISB", &Cpu::OpISB, &Cpu::AddrZP0, 5 };
    instructionLookupTable[0xEB] = { "SBC", &Cpu::OpSBC, &Cpu::AddrIMM, 2 };
    instructionLookupTable[0xEF] = { "ISB", &Cpu::OpISB, &Cpu::AddrABS, 6 };
    instructionLookupTable[0xF3] = { "ISB", &Cpu::OpISB, &Cpu::AddrIZY, 8 };
    instructionLookupTable[0xF7] = { "ISB", &Cpu::OpISB, &Cpu::AddrZPX, 6 };
    instructionLookupTable[0xFB] = { "ISB", &Cpu::OpISB, &Cpu::AddrABY, 7 };
    instructionLookupTable[0xFF] = { "ISB", &Cpu::OpISB, &Cpu::AddrABX, 7 };    
    // instructionLookupTable[0x4B] = { "ALR", &Cpu::OpALR, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0x0B] = { "ANC", &Cpu::OpANC, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0x2B] = { "ANC", &Cpu::OpANC, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0x8B] = { "ANE", &Cpu::OpANE, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0x6B] = { "ARR", &Cpu::OpARR, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0x93] = { "SHA", &Cpu::OpSHA, &Cpu::AddrIZY, 6 };
    // instructionLookupTable[0x9C] = { "SHY", &Cpu::OpSHY, &Cpu::AddrABX, 5 };
    // instructionLookupTable[0x9E] = { "SHX", &Cpu::OpSHX, &Cpu::AddrABY, 5 };
    // instructionLookupTable[0x9F] = { "SHA", &Cpu::OpSHA, &Cpu::AddrABY, 5 };
    // instructionLookupTable[0xAB] = { "LXA", &Cpu::OpLXA, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0xBB] = { "LAS", &Cpu::OpLAS, &Cpu::AddrABY, 4 };
    // instructionLookupTable[0xCB] = { "SBX", &Cpu::OpSBX, &Cpu::AddrIMM, 2 };
    // instructionLookupTable[0x9B] = { "TAS", &Cpu::OpTAS, &Cpu::AddrABY, 5 };
    // instructionLookupTable[0x6A] = { "ROR", &Cpu::OpROR, &Cpu::AddrACC, 2 };
    // instructionLookupTable[0x66] = { "ROR", &Cpu::OpROR, &Cpu::AddrZP0, 5 };
    // instructionLookupTable[0x76] = { "ROR", &Cpu::OpROR, &Cpu::AddrZPX, 6 };
    // instructionLookupTable[0x6E] = { "ROR", &Cpu::OpROR, &Cpu::AddrABS, 6 };
    // instructionLookupTable[0x7E] = { "ROR", &Cpu::OpROR, &Cpu::AddrABX, 7 };
    // instructionLookupTable[0x80] = { "BRA", &Cpu::OpBRA, &Cpu::AddrREL, 3 };
    // instructionLookupTable[0xFA] = { "PLA", &Cpu::OpPLA, &Cpu::AddrIMP, 4 };
    // instructionLookupTable[0x7A] = { "PLA", &Cpu::OpPLA, &Cpu::AddrIMP, 4 };
    // instructionLookupTable[0xDB] = { "STP", &Cpu::OpSTP, &Cpu::AddrIMP, 3 };
    // instructionLookupTable[0x64] = { "STZ", &Cpu::OpSTZ, &Cpu::AddrZP0, 3 };
    // instructionLookupTable[0x74] = { "STZ", &Cpu::OpSTZ, &Cpu::AddrZPX, 4 };
    // instructionLookupTable[0x9C] = { "STZ", &Cpu::OpSTZ, &Cpu::AddrABS, 4 };
    // instructionLookupTable[0x9E] = { "STZ", &Cpu::OpSTZ, &Cpu::AddrABX, 4 };
    // instructionLookupTable[0x1C] = { "TRB", &Cpu::OpTRB, &Cpu::AddrABS, 6 };
    // instructionLookupTable[0x14] = { "TRB", &Cpu::OpTRB, &Cpu::AddrZP0, 5 };
    // instructionLookupTable[0x0C] = { "TRB", &Cpu::OpTRB, &Cpu::AddrABS, 6 };
    // instructionLookupTable[0x04] = { "TRB", &Cpu::OpTRB, &Cpu::AddrZP0, 5 };
    // instructionLookupTable[0xCB] = { "WAI", &Cpu::OpWAI, &Cpu::AddrIMP, 3 };
